...
export const navigation: Array<NavGroup> = [
  ...
  },
  {
    title: 'Terminologies',
    links: [
      { title: 'NAMASTE CodeSystem', href: '/terminologies/namaste' },
      { title: 'ICD-11 Integration', href: '/terminologies/icd11' },
      { title: 'WHO Ayurveda', href: '/terminologies/who-ayurveda' },
    ],
  },
  {
    title: 'Advanced Features',
    links: [
      { title: 'Dual Coding', href: '/features/dual-coding' },
      { title: 'Batch Operations', href: '/features/batch-operations' },
      { title: 'Monitoring', href: '/features/monitoring' },
      { title: 'Deployment', href: '/features/deployment' },
    ],
  },
]
